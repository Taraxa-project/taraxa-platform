...
export class Schema1665592831789 implements MigrationInterface {
  name = 'Schema1665592831789';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "pbfts" ("id" SERIAL NOT NULL, "hash" character varying NOT NULL, "number" integer NOT NULL, "timestamp" integer NOT NULL DEFAULT '0', "nonce" character varying, "miner" character varying, "reward" bigint, "gasLimit" character varying, "gasUsed" character varying, "parent" character varying, "difficulty" integer, "totalDifficulty" integer, "transactionCount" integer, CONSTRAINT "UQ_35a84f8058f83feff8f2941de6a" UNIQUE ("hash"), CONSTRAINT "PK_6f76845d0ce6ec5233cc8eab5e6" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "transactions" ("id" SERIAL NOT NULL, "hash" character varying NOT NULL, "nonce" integer, "index" integer, "value" character varying, "gasPrice" character varying, "gas" character varying, "gasUsed" character varying, "cumulativeGasUsed" integer, "inputData" character varying, "status" integer, "from" character varying, "to" character varying, "blockId" integer, CONSTRAINT "UQ_6f30cde2f4cf5a630e053758400" UNIQUE ("hash"), CONSTRAINT "PK_a219afd8dd77ed80f5a862f1db9" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
