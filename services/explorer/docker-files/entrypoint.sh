...
export OVERRIDE_FAUCET=${OVERRIDE_FAUCET:=""}
...
OVERRIDE_FAUCET=${OVERRIDE_FAUCET%/}
...
find $STATIC_FOLDER -type f -exec sed -i "s,REACT_APP_OVERRIDE_FAUCET_STRING_REPLACE,$OVERRIDE_FAUCET,g" {} \;
