...
export TARAXA_OVERRIDE_RPC_PROVIDER=${TARAXA_OVERRIDE_RPC_PROVIDER:=""}
export TARAXA_OVERRIDE_GRAPHQL_PROVIDER=${TARAXA_OVERRIDE_GRAPHQL_PROVIDER:=""}
export TARAXA_OVERRIDE_API=${TARAXA_OVERRIDE_API:=""}
export TARAXA_OVERRIDE_FAUCET=${TARAXA_OVERRIDE_FAUCET:=""}
...
TARAXA_OVERRIDE_RPC_PROVIDER=${TARAXA_OVERRIDE_RPC_PROVIDER%/}
TARAXA_OVERRIDE_GRAPHQL_PROVIDER=${TARAXA_OVERRIDE_GRAPHQL_PROVIDER%/}
TARAXA_OVERRIDE_API=${TARAXA_OVERRIDE_API%/}
TARAXA_OVERRIDE_FAUCET=${TARAXA_OVERRIDE_FAUCET%/}
...
find $STATIC_FOLDER -type f -exec sed -i "s,REACT_APP_TARAXA_OVERRIDE_RPC_PROVIDER_STRING_REPLACE,$TARAXA_OVERRIDE_RPC_PROVIDER,g" {} \;
find $STATIC_FOLDER -type f -exec sed -i "s,REACT_APP_TARAXA_OVERRIDE_GRAPHQL_PROVIDER_STRING_REPLACE,$TARAXA_OVERRIDE_GRAPHQL_PROVIDER,g" {} \;
find $STATIC_FOLDER -type f -exec sed -i "s,REACT_APP_TARAXA_OVERRIDE_API_STRING_REPLACE,$TARAXA_OVERRIDE_API,g" {} \;
find $STATIC_FOLDER -type f -exec sed -i "s,REACT_APP_TARAXA_OVERRIDE_FAUCET_STRING_REPLACE,$TARAXA_OVERRIDE_FAUCET,g" {} \;
