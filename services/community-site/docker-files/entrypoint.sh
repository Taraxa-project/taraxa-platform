...
export API_TARAXA_HOST=${API_TARAXA_HOST:="https://api.taraxa.io"}
...
API_TARAXA_HOST=${API_TARAXA_HOST%/}
...
find $STATIC_FOLDER -type f -exec sed -i "s,REACT_APP_API_TARAXA_HOST_STRING_REPLACE,$API_TARAXA_HOST,g" {} \;
