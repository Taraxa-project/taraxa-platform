...
export DPOS_SUBGRAPH_HOST=${DPOS_SUBGRAPH_HOST}
...
DPOS_SUBGRAPH_HOST=${DPOS_SUBGRAPH_HOST%/}
...
find $STATIC_FOLDER -type f -exec sed -i "s,REACT_APP_DPOS_SUBGRAPH_HOST_STRING_REPLACE,$DPOS_SUBGRAPH_HOST,g" {} \;
exec "$@"
