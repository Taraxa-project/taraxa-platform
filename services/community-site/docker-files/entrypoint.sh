...
export INDEXER_API_HOST=${INDEXER_API_HOST:="https://indexer.mainnet.taraxa.io"}
...
INDEXER_API_HOST=${INDEXER_API_HOST%/}
...
find $STATIC_FOLDER -type f -exec sed -i "s,REACT_APP_INDEXER_API_HOST_STRING_REPLACE,$INDEXER_API_HOST,g" {} \;
