            ...
            <>
              ...
              {pinnedBounties.map((pinnedBounty) => {
                ...
                if (pinnedBounty.submissions!.length > 0) {
                  ...
                  const mobileRows = pinnedBounty.submissions!.map((submission) => ({
                    Icon: UserIcon,
                    data: [
                      {
                        username: submission.user.username,
                  ...
                  <div className="cardContainer">
                    {isMobile ? (
                      <VerticalRewardCard
                        ...
                        expiration={new Date(pinnedBounty.end_date).toLocaleDateString()}
                      ...
                      <RewardCard
                        ...
                        description={pinnedBounty.description}
                        onClickButton={() =>
                          detailsPage ? setSubmitPage(true) : setDetailsPage(true)
                        }
