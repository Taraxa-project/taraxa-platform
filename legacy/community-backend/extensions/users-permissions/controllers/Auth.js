    ...
    if (!gres.data.success) {
      return ctx.badRequest(
        ...
        formatError({
          ...
          message:
            'Seems like there is an issue with your request. Please wait a couple of minutes and try again.',
        }),
      );
    }
      ...
      if (!gres.data.success) {
        return ctx.badRequest(
          ...
          formatError({
            id: 'Auth.form.error.invalid.token',
            message:
              'Seems like there is an issue with your submission. Please wait a couple of minutes and try again.',
          }),
        );
      }
    }
